...
public:
	...
	void ComputeFlux(int n, const double_type* x, int m, double_type* fcavp, int i, int direction = 0, bool simple = false);
	void ComputePositiveFlux(int n, const double_type* x, int m, double_type* fcavp, int i, bool simple = false);
	void ComputeNegativeFlux(int n, const double_type* x, int m, double_type* fcavp, int i, bool simple = false);
